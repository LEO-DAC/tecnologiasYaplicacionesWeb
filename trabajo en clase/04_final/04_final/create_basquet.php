    ...
    <div class= "container">
       <div class = "table-wrapper">
            ...
            if (isset($_POST) && !empty($_POST)) {  //se validan los campos del formulario
              ...
              //$pdoQuery = "INSERT INTO `futbolistas`(`nombre`, `posicion`,`carrera`,`email`) VALUES (:nombre,:posicion,:carrera,:email)";
              //$pdoResult = $pdoConnect->prepare($pdoQuery);
              // se crea un usuario con in insert
              //$pdoExec = $pdoResult->execute(array(":nombre"=>$nombre,":posicion"=>$posicion,":carrera"=>$carrera,":email"=>$email));
            ...
            $consulta = "INSERT INTO basquetbolista (nombre,posicion,carrera,email) VALUES (";
