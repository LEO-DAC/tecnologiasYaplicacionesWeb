    ...
    <div class= "container">
       <div class = "table-wrapper">
            <div class= "table-title">
                <div class ="row">
                      <div class="col-sm-8"><h2>Modificar <b>basquetbolista</b></h2></div>
            ...
            $consulta = $conexion->prepare("SELECT * FROM basquetbolista WHERE id = :id ");
            ...
            $consulta = "UPDATE basquetbolista SET nombre='$nombre',posicion='$posicion',carrera='$carrera',email='$email' WHERE id=$id";
