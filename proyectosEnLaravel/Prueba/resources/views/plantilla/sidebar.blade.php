<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            <!-- Inicializamos la variable menú en 0 declarada en componente app.js -->
            ...
            <li class="nav-item nav-dropdown">
                <a class="nav-link nav-dropdown-toggle"><i class="icon-bag"></i> Almacén</a>
            ...
            <li class="nav-item nav-dropdown">
                <a class="nav-link nav-dropdown-toggle"><i class="icon-wallet"></i> Compras</a>
                <ul class="nav-dropdown-items">
            ...
            <li class="nav-item nav-dropdown">
                <a class="nav-link nav-dropdown-toggle"><i class="icon-basket"></i> Ventas</a>
                <ul class="nav-dropdown-items">
            ...
            <li class="nav-item nav-dropdown">
                <a class="nav-link nav-dropdown-toggle" ><i class="icon-people"></i> Acceso</a>
                <ul class="nav-dropdown-items">
            ...
            <li class="nav-item nav-dropdown">
                <a class="nav-link nav-dropdown-toggle"><i class="icon-pie-chart"></i> Reportes</a>
                <ul class="nav-dropdown-items">
